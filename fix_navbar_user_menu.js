...
const mobile_search = '<span className="font-semibold text-gray-200">{currentUser.displayName}</span>';
const mobile_replace = `<div className="relative">
              <button 
